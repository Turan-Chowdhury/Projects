...
<div class="container-fluid">
	...
	<div class="login" style="background-color:#fff;">
			<h3 class="text-center mx-auto" style="background-color:light;color: dark;"><u>Admin Panel<u/></h3>
				<div class="formstyle" style="float: right;padding-top:20px;padding-bottom:0px;padding-right:0px;padding-left:50px;border: 1px solid light-gray;margin-right:489px; margin-bottom:7px;background-color:#f3f3f8;color:#141313;height:245px;">
					<form action="" method="post">
						<label class="form-group">
							 <input style="margin-left:100px;margin-top:20px;"class="form-control form-control-sm" type="text" name="username"  placeholder="username" required>
						</label><br><br>
						<label class="form-group">
							 <input class="form-control form-control-sm" type="password" name="password"  placeholder="password" required>
						</label><br><br>
						<button class="btn btn-success" name="submit" type="submit" style="margin-left:120px;margin-bottom:20px;width: 85px;border-radius: 8px;">Login</button> 
			...
			<?php 
							...
							if ($result->num_rows > 0) {
									...
									echo "<span style='color:red;margin-left:130px;'>Invalid username or password</span>";
								}
						$conn->close();		
					}
