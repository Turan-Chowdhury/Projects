                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('hotel_name',$hotel->hotel_name,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::number('room_numbers',$hotel->room_numbers,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::number('minimum_price',$hotel->minimum_price,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('hotel_facilities',$hotel->hotel_facilities,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::textarea('address',$hotel->address,['class'=>'form-control','rows'=>'3'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::textarea('description',$hotel->description,['class'=>'form-control','rows'=>'3'])}}
