                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('hotel_name','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::number('room_numbers','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::number('minimum_price','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('hotel_facilities','',['class'=>'form-control'])}}
