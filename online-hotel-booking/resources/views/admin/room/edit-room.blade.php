                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('room_name',$room->room_name,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('room_code',$room->room_code,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('number_of_room',$room->number_of_room,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::number('price_per_night',$room->price_per_night,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::number('room_capacity',$room->room_capacity,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('room_facilities',$room->room_facilities,['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::textarea('description',$room->description,['class'=>'form-control','rows'=>'3'])}}
