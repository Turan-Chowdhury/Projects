                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('room_name','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('room_code','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('number_of_room','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::number('price_per_night','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::number('room_capacity','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('room_facilities','',['class'=>'form-control'])}}
