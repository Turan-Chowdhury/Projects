            ...
            <div class="card shadow border-warning">
                <div class="card-body border-dark">
                    ...
                    <div class="form-group text-center col-md-2">
                        ...
                        <select class="form-control" name="adult_select_value" id="adult_select_value">
                                <option disabled selected>{{'Select Number of Adult'}}</option>
                    ...
                    <div class="form-group text-center col-md-2">
                        ...
                        <select class="form-control" name="child_select_value" id="child_select_value" required>
                            <option disabled selected>{{'Select Number of Child'}}</option>
